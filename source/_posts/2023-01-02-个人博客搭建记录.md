...
由于我们仓库实际上还没有初始化，需要使用 git 初始化一下仓库再进行提交，提交命令如下
...
可以看到此时我们已经调整完成，提示我们网站已经上线了，进入 [https://purewhitevk.github.io](https://purewhitevk.github.io) 就可以访问到部署好的博客页面了。（github.io访问速度可能较慢，最好挂梯子）
